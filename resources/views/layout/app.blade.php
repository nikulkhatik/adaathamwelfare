...
<head>
    ...
    <title>
        શ્રી અડા આઠમ મેવાડા સુથાર વેલફેર ટ્રસ્ટ આપનું હાર્દીક સ્વાગત કરે છે.
    </title>
    <link href="{{asset('css/shivshaktisoftware.css')}}" rel="stylesheet" type="text/css"/>
    ...
    <script type="text/javascript">
        function jsDecimals(e) {
            ...
            if (key != null) {
                key = parseInt(key, 10);
                if ((key < 48 || key > 57) && (key < 96 || key > 105) && (key != 109)) {
        ...
        function jsIsUserFriendlyChar(val, step) {
            ...
            if (val == 8 || val == 9 || val == 13 || val == 45 || val == 46 || val == 189) {
                return true;
            }
    ...
    <style type="text/css">
        ...
        .auto-styleSJ {
            ...
            width: 200px;
            height: 200px;
            background: url('images/logo_adaatham.png') no-repeat;
            text-align: center;
        }
        ...
        .auto-styleSJinfo1 {
            ...
            width: 200px;
            height: 200px;
            background: url('images/logo_adaatham2.png') no-repeat;
            text-align: center;
        }
        ...
        .auto-styleSJinfo2 {
            ...
            width: 200px;
            height: 200px;
            background: url('images/logo_adaatham1.png') no-repeat;
            text-align: center;
        }
        ...
        .auto-styleContainPara {
            ...
            font-family: "Bloomberg Prop Unicode I", Verdana, sans-serif;
            font-size: 105%;
        }
